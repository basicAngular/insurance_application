...
export const verticalMenuItems = [ 
    ...
    new Menu (20, 'Blog Posts', null, null, 'pencil-square-o', null, true, 0),
    new Menu (21, 'Create Blog', '/pages/create-blog', null, 'pencil', null, false, 20),
    new Menu (12, 'Form Controls', '/pages/form-elements/', null, 'check-square-o', null, false, 20),
    ...
    new Menu (43, 'Home', '/pages/page-home', null, 'Home', null, false, 40),
    new Menu (44, 'About', '/pages/page-about', null, 'About', null, false, 40),
    new Menu (45, 'Contact', '/pages/page-contact', null, 'Contact', null, false, 40),
    new Menu (46, 'Term And Condition', '/pages/page-term-condition', null, 'Condition', null, false, 40),
